...
// const releaseFerstIPhone = 2007
// alert(releaseFerstIPhone)

// Задание 3
// Создайте переменную и присвойте ей значение имени создателя языка JavaScript. Выведите значение переменной на экран.

// const creatorJavaScript = ('Брендан Эйх');
// alert(creatorJavaScript);


// Задание 4
// Создайте две переменные 10 и 2. С помощью метода alert()выведите на экран их сумму, разность, произведение и частное
//  (результат деления).
...
// let age = prompt('Сколько вам лeт?')
// alert(age);
...
// Задание 9.4
// Создайте переменную info,присвойте ей значение с помощью метода prompt()
// "Какую информацию хотите узнать о пользователе?".Далее обращайтесь к свойствам объекта 
...
// let nume = prompt('Напишите свое имя')
// alert(`Привет,${nume}!`)